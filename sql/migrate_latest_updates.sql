...
ON CONFLICT (key) DO UPDATE SET text_value = COALESCE(kpi_thresholds.text_value, EXCLUDED.text_value);
...
-- Desanida el inventario JSONB en filas individuales con sus campos correspondientes
