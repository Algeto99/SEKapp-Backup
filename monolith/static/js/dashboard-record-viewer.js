(function() {
    ...
    const FIVE_Q_MAP = {
        reporte_incidente: {
            QUE:    ['Tipo de Incidente', 'Categoría', 'Título de Incidencia'],
            CUANDO: ['Fecha y Hora', 'Fecha del Incidente'],
            DONDE:  ['Cliente / Empresa', 'Propiedad / Instalación', 'Puesto o Área Específica', 'Lugar del Incidente', 'Propiedad'],
            COMO:   ['Nivel de Severidad', 'Nivel Severidad', 'Descripción', 'Descripción del Incidente', 'Descripción del Impacto', 'Plan de Acción', 'URLs de Imágenes o PDFs', 'Foto Evidencia'],
            QUIEN:  ['Nombre del Responsable', 'Rol del Aplicador/Responsable', 'Nombre del Supervisor', 'Responsable Asignado'],
        },
        supervision_puesto: {
            QUE:    ['Puesto o Área Específica', 'Tipo de Instalación', 'Modalidad de Servicio'],
            CUANDO: ['Fecha y Hora', 'Fecha/Hora'],
            DONDE:  ['Cliente / Empresa', 'Propiedad / Instalación', 'Cliente'],
            COMO:   ['Observaciones / Novedades', 'Observaciones', 'Foto Evidencia', 'URLs de Imágenes o PDFs'],
            QUIEN:  ['Nombre Supervisor', 'Supervisor', 'Nombre del Guardia', 'Nombre Guardia', 'Rol del Aplicador/Responsable'],
        },
        checklist_cumplimiento: {
            QUE:    ['Curso / Certificación', 'Curso Certificación', 'Nivel de Cumplimiento', 'Nivel Cumplimiento'],
            CUANDO: ['Fecha y Hora', 'Fecha/Hora'],
            DONDE:  ['Cliente / Empresa', 'Propiedad / Instalación', 'Puesto o Área Específica', 'Cliente'],
            COMO:   ['Foto Evidencia', 'URLs de Imágenes o PDFs', 'Evidencia URL'],
        ...
        medicion_experiencia_cliente: {
            ...
            QUIEN:  ['Encuestado', 'Nombre del Responsable', 'Rol del Aplicador/Responsable'],
        },
        informe_novedades_disciplinario: {
            QUE:    ['Tipo de Novedad / Falta', 'Tipo de Novedad', 'Tipo Novedad'],
            CUANDO: ['Fecha y Hora', 'Fecha/Hora'],
            DONDE:  ['Sitio donde ocurrió', 'Propiedad / Instalación', 'Sitio'],
            COMO:   ['Descripción de la Novedad', 'Descripción', 'Anexos / Evidencias', 'Foto Evidencia'],
            QUIEN:  ['Nombre del Colaborador', 'Empleado', 'Nombre del Responsable', 'Responsable'],
        },
        log_de_patrullas: {
            QUE:    ['Nivel de Riesgo', 'Nivel Riesgo', 'Estado Patrulla', 'Estado'],
            CUANDO: ['Fecha', 'Hora Inicio', 'Hora Fin'],
            DONDE:  ['Sitio / Ubicación', 'Sitio'],
            COMO:   ['Detalles Incidente', 'Riesgo Detectado', 'Contexto / Observaciones', 'Contexto'],
            QUIEN:  ['ID Guardia / Nombre Guardia', 'Guardia'],
        },
        registro_de_capacitaciones: {
            QUE:    ['Tema de la Capacitación', 'Capacitación', 'Objetivo'],
            CUANDO: ['Fecha y Hora', 'Fecha/Hora'],
            DONDE:  ['Cliente / Empresa', 'Propiedad / Instalación'],
            COMO:   ['Fotos/Documentos', 'Foto Evidencia', 'URLs de Imágenes o PDFs', 'Observaciones', 'Nivel Comprensión'],
            QUIEN:  ['Nombre del Responsable/Capacitador', 'Nombre del Responsable', 'Responsable'],
        },
        registro_y_acta_de_visita: {
            QUE:    ['Motivo de la Visita', 'Motivo', 'Objetivo'],
            CUANDO: ['Fecha y Hora', 'Fecha/Hora'],
            DONDE:  ['Cliente / Empresa', 'Propiedad / Instalación', 'Cliente'],
            COMO:   ['Temas Tratados', 'Acuerdos y Compromisos', 'Acuerdos'],
            QUIEN:  ['Nombre del Visitante', 'Visitante', 'Atendió'],
        },
        planilla_vehicular: {
        ...
        confiabilidad_equipos: {
            QUE:    [],
            CUANDO: ['Fecha', 'Hora'],
            DONDE:  ['Cliente / Empresa', 'Propiedad / Instalación', 'Sitio / Ubicación', 'Sitio', 'Cliente'],
            COMO:   [],
            QUIEN:  ['Técnico de Mantenimiento', 'Técnico Mantenimiento', 'Supervisor de Seguridad', 'Supervisor Seguridad'],
        },
    };
