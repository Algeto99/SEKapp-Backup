...
@forms_bp.route('/mantenimiento_seguridad_fisica')
@jwt_required()
...
@forms_bp.route('/submit_mantenimiento_seguridad_fisica', methods=['POST'])
@jwt_required()
...
@forms_bp.route('/orden_mantenimiento')
@jwt_required()
...
@forms_bp.route('/submit_orden_mantenimiento', methods=['POST'])
@jwt_required()
